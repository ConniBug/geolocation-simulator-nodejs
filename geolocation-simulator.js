...
*  MIT License
*
* Conni Bilham - Modified to allow functionality on node.js
*
* exported GeolocationSimulation
* - GeolocationSimulation contains .getCurrentLocation, .watchPosition, .clearWatch
*/
...
module.exports.GeolocationSimulation = function(params) {
    var self = {};
    //private vars
    ...
    function nextCoord() {
        ...
        if(_index < _coords.length - 1) {
            ...
            //path is complete
            console.error('you have arrived!');
        }
    }
    ...
    self.watchPosition = function(cb,error,options) {
